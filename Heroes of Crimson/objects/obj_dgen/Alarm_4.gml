...
for (var xx = 0; xx < floor_w; xx++) {
    for (var yy = 0; yy < floor_h; yy++) {
        switch tile_grid[# xx, yy] {
			...
			case 2: 
			case 3:
                tile_add(bg_tiles, tile_s * 0, tile_s * irandom_range(2, 6), tile_s, tile_s, offset_x + xx * tile_s, offset_y + yy * tile_s, tile_depth);
				break;
            case 1:
                tile_add(bg_tiles, tile_s * 0, tile_s * 0, tile_s, tile_s, offset_x + xx * tile_s, offset_y + yy * tile_s, -tile_depth);
				break;
            case 4:
                tile_add(bg_tiles, tile_s * 0, tile_s * 1, tile_s, tile_s, offset_x + xx * tile_s, offset_y + yy * tile_s, tile_depth);
				break;
        }
    }
}

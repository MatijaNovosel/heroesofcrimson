...
for(var i = 0; i < floor_count; i++) {
    ...
    global.Floor_name[i] = "Chambers of the Undead, floor " + string(i + 1);
    ...
    room_set_background_colour(global.Floor_room_id[i], scr_cformat($091526), true);
    
    // Clear the room, then create a dungeon generator to create the floor
    room_instance_add(global.Floor_room_id[i], 0, 0, obj_dgen);
}

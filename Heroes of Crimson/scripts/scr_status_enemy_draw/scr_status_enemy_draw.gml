/// @description  scr_status_enemy_draw(x, y);
/// @param x
/// @param  y
...
if (hp > 0) && (!collision_line(x, y, global.playerInstance.x, global.playerInstance.y, obj_wall_par, false, true)) && !scr_status_find(status.invis, self)
{

...
for (var aa = 0; aa < corr_total; aa ++)
{
    ...
    if (tile_grid[# cbox_left[aa] - 1, cbox_top[aa] - 1] == -4) && (room_grid[# cbox_left[aa] - 1, cbox_top[aa] - 1] == -1)
    ...
    if (tile_grid[# cbox_right[aa] + 1, cbox_top[aa] - 1] == -4) && (room_grid[# cbox_right[aa] + 1, cbox_top[aa] - 1] == -1)
    ...
    if (tile_grid[# cbox_left[aa] - 1, cbox_bottom[aa] + 1] == -4) && (room_grid[# cbox_left[aa] - 1, cbox_bottom[aa] + 1] == -1)
    ...
    if (tile_grid[# cbox_right[aa] + 1, cbox_bottom[aa] + 1] == -4) && (room_grid[# cbox_right[aa] + 1, cbox_bottom[aa] + 1] == -1)
